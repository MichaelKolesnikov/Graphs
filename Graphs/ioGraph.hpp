...
namespace Graphs {
    ...
    void create_picture(const std::string& filename, const std::string& output_image) {
        std::string command = "dot -Tpng " + escape_shell_arg(filename) + " -o " + escape_shell_arg(output_image);
